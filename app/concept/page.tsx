...
const TENSIONS = [
  {
    a: "LOGIC",
    b: "CREATIVITY",
    body: "ความคิดสร้างสรรค์ที่ไม่มีระบบ ใช้จริงไม่ได้ และระบบที่ไม่มีความคิดสร้างสรรค์ ก็สร้างสิ่งใหม่ไม่ได้",
  },
  {
    a: "HUMAN",
    b: "MACHINE",
    body: "AI ไม่ได้มาแทนมนุษย์ แต่มาขยายความสามารถ — คนกำหนดทิศทาง AI เพิ่มความเร็ว",
  },
  {
    a: "CHAOS",
    b: "SYSTEM",
    body: "เครื่องมือเยอะเกิน เปลี่ยนเร็วเกิน — เราเปลี่ยน Chaos ให้เป็น System ที่คุณปรับตัวต่อได้เอง",
  },
];
        ...
        <div className="container-x relative pb-16">
          ...
          <Reveal delay={0.14}>
            <p className="mt-7 max-w-2xl text-fluid-lg leading-relaxed text-white/65">
              DeCODE อยู่ระหว่างความคิดสร้างสรรค์กับระบบ —
              เปลี่ยน AI จากสิ่งไกลตัว ให้เป็นสิ่งที่คุณควบคุมและใช้สร้างผลลัพธ์ได้จริง
            </p>
          </Reveal>
        </div>
      </section>
