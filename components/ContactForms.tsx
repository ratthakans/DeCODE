...
const inputCls =
  "w-full rounded-xl border border-white/10 bg-ink/60 px-4 py-3 text-sm text-white placeholder-white/30 outline-none transition-colors focus:border-teal-300/50 focus:bg-ink/80";
...
function SuccessNote({ text }: { text: string }) {
  return (
    <motion.div
      ...
      className="rounded-2xl border border-lime/25 bg-lime/[0.06] p-6 text-center"
    >
      <div className="mx-auto mb-3 flex h-11 w-11 items-center justify-center rounded-full bg-lime text-ink">
        ✓
      </div>
