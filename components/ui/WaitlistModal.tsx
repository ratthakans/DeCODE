            ...
            >
              <div className="p-8">
                ...
                <p className="text-sm text-white/60 mb-6">
                  สำหรับคอร์ส <span className="text-emerald-400 font-medium">{courseTitle}</span>
                </p>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                      ...
                      <input 
                        ...
                        name="name" 
                        required 
                        className="w-full rounded-xl border border-white/10 bg-black/50 px-4 py-3 text-sm text-white placeholder-white/30 focus:border-emerald-500/50 focus:outline-none focus:ring-1 focus:ring-emerald-500/50 transition-colors"
                    ...
                    <div className="mt-8 flex gap-3">
                      ...
                      <button
                        ...
                        className="flex-1 rounded-full bg-emerald-500 py-3 text-sm font-medium text-black hover:bg-emerald-400 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                      >
