...
export function StatusBadge({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 rounded-full border border-aurora-300/20 bg-aurora-300/5 font-mono uppercase tracking-[0.14em] text-mint/90 ${pad}`}
    >
