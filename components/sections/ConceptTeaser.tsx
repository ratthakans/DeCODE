      ...
      <div className="container-x">
        ...
        <div className="grid gap-4 md:grid-cols-3 md:grid-rows-2 lg:gap-6">
          ...
          <Reveal delay={0.2} className="md:col-span-2">
            <div className="group relative h-full overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 transition-colors hover:bg-white/10">
          ...
          <Reveal delay={0.4}>
            <div className="relative h-full overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 transition-colors hover:bg-white/10">
