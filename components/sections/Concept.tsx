...
const FORCES = [
  {
    ...
    body: "รู้ว่าเครื่องมือแต่ละตัวควรอยู่ตรงไหนของกระบวนการ ไม่ใช่สุ่มลอง",
    keywords: ["Logic", "Framework", "System", "Process"],
  },
  {
    name: "CLARITY",
    gloss: "ถอดรหัสความซับซ้อน",
    body: "เปลี่ยนเรื่องยากให้เข้าใจและใช้ได้จริง เห็นชัดว่าควรทำอะไรต่อ",
    keywords: ["Knowledge", "Focus", "Judgement", "Confidence"],
  },
  {
    name: "INTELLIGENCE",
    gloss: "พลังที่กำลังเคลื่อนไหว",
    body: "ความสามารถใหม่ที่เกิดขึ้นเมื่อมนุษย์ใช้เครื่องจักรได้ถูกต้อง",
        ...
        <Reveal>
          <div className="mx-auto mb-14 max-w-2xl text-center">
            ...
            <p className="mt-5 leading-relaxed text-white/55">
              เปลี่ยนความคิดให้เป็นระบบ และเทคโนโลยีให้เป็นความสามารถทางธุรกิจ
            </p>
          </div>
        </Reveal>
