    ...
    <div className="flex justify-between gap-4">
      ...
      <span
        className={`text-right ${
          highlight ? "font-medium text-aurora-200" : "text-white/80"
        }`}
      >
        {value}
      </span>
    ...
    <section className="relative overflow-hidden bg-black pt-28 pb-16 md:pt-36 md:pb-24">
      <div className="container-x relative">
        <Reveal>
          <Link
            href="/courses"
            className="group inline-flex items-center gap-2 text-sm text-white/50 transition-colors hover:text-aurora-100"
          >
              ...
              <div className="overflow-hidden rounded-3xl border border-white/10 bg-ink-100/50 shadow-sm backdrop-blur">
                ...
                <div className="p-6">
                  ...
                  {available && course.launchDate && (
                    <div className="mb-5">
                      <p className="mb-2 font-mono text-[0.65rem] uppercase tracking-[0.2em] text-aurora-200/80">
                        เริ่มเรียนใน
                      </p>
