      ...
      <div className="relative overflow-hidden rounded-[26px] border border-white/16 bg-ink-100">
        ...
        <div className="relative grid md:grid-cols-[1.2fr_0.9fr]">
          ...
          <div className="p-8 sm:p-12">
            <span className="inline-flex items-center gap-2 rounded-full px-3.5 py-1.5 text-xs font-semibold text-[#04211d] aurora-bg">
              ● {course.statusLabel} · เหลือ {course.seatsAvailable} ที่นั่ง
            </span>
            <h3 className="mt-5 font-display text-[clamp(1.8rem,1.2rem+2vw,2.8rem)] font-semibold leading-[1.05] tracking-[-0.03em] text-white">
              {course.title}
              {course.edition && (
            ...
            <div className="mt-8 flex flex-wrap items-center gap-5">
              <div className="flex items-baseline gap-2">
                <b className="font-grotesk text-3xl font-semibold tracking-[-0.02em] text-white tabular-nums">
